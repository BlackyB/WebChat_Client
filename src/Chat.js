...
class Chat extends Component {
  ...
  // Etablish connexion between the app and the remote websocket server with the URL provided on line 6
  ...
  submitMessage = messageString => {
    const message = { name: this.state.name, message: messageString, date: getNow(), highlight: false}
